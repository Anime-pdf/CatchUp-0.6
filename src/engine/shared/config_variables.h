...
MACRO_CONFIG_STR(SvName, sv_name, 128, "CatchUp Test", CFGFLAG_SERVER, "Server name")
...
MACRO_CONFIG_STR(SvMap, sv_map, 128, "ddd1", CFGFLAG_SERVER, "Map to use on the server")
...
MACRO_CONFIG_INT(SvRconMaxTries, sv_rcon_max_tries, 5, 0, 100, CFGFLAG_SERVER, "Maximum number of tries for remote console authentication")
...
//CatchUp
MACRO_CONFIG_INT(SvWeapons, sv_withweapons, 0, 0, 1, CFGFLAG_SERVER, "Spawn players with weapons")
...
MACRO_CONFIG_INT(SvTestingCommands, sv_test_cmds, 1, 0, 1, CFGFLAG_SERVER, "Turns testing commands aka cheats on/off (setting only works in initial config)")
